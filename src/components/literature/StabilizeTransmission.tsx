...
export default function StabilizeTransmission() {
  ...
  return (
    <section
      ...
      style={{ border: `1px solid ${BORDER}`, backgroundColor: 'rgba(10,11,28,0.5)', borderRadius: '3px', padding: '32px', textAlign: 'center' }}
    >
      <h3 id="pi-stabilize-title" style={{ fontFamily: "'Cinzel', serif", fontSize: '1rem', fontWeight: 400, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#b32435', marginBottom: '8px' }}>
        Stabilize the Transmission
      </h3>
      <p style={{ fontFamily: SERIF, fontSize: '1.05rem', color: 'rgba(212,197,181,0.7)', maxWidth: '46ch', margin: '0 auto 24px', lineHeight: 1.6 }}>
      ...
      <div
        ...
        style={{ height: '10px', maxWidth: '32rem', margin: '0 auto 20px', borderRadius: '999px', border: `1px solid ${BORDER}`, overflow: 'hidden', backgroundColor: 'rgba(212,197,181,0.06)' }}
      >
        <div style={{ height: '100%', width: `${stability}%`, background: 'linear-gradient(90deg, rgba(125,167,217,0.8), #b32435)', transition: 'width 0.3s ease' }} />
      </div>

      <label htmlFor="pi-stabilize-range" style={{ position: 'absolute', width: 1, height: 1, overflow: 'hidden', clip: 'rect(0 0 0 0)' }}>
      ...
      <p aria-live="polite" style={{ fontFamily: MONO, fontSize: '0.8rem', color: 'rgba(212,197,181,0.7)', marginTop: '16px' }}>
        Stability: {stability}% {locked ? '· LOCKED' : '· searching…'}
      </p>

      {locked && (
        <p style={{ fontFamily: SERIF, fontStyle: 'italic', fontSize: '1.2rem', color: '#f7e6b7', marginTop: '16px' }}>
