  ...
  return (
    ...
    >
      {character.portraitImg && (
        ...
        >
          <img
            src={character.portraitImg}
            alt={character.portraitAlt ?? character.name}
            loading="lazy"
            style={{
              width: '100%',
              height: '100%',
        ...
        <details style={{ marginTop: '16px' }}>
          ...
          <div style={{ marginTop: '10px' }}>
            {character.spoilerLocked.map((line, i) => (
              <p
                key={i}
                style={{ fontFamily: SERIF, fontSize: '1rem', color: BODY, lineHeight: 1.7 }}
              >
                {line}
              </p>
            ))}
