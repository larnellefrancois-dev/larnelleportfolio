...
export const paleIntervalCharacters: CharacterDossier[] = [
  {
    ...
    portraitImg: '/assets/literature/character-profiles/sela-mares.jpg',
    portraitAlt: 'Cinematic profile image for Sela Mares inside a damaged NAIAD cockpit.',
    description:
      'Brilliant, secretive, sleep-starved, and dangerous when private certainty outruns shared risk. Sela built an illegal listener in NAIAD’s auxiliary navigation annex and spent twelve years proving the hole in Adra’s fragment has walls.',
  ...
  },
  {
    ...
    description:
      'Sela’s mother, a xenosemiotician whose final ninety-seven-second transmission refuses every soft institutional explanation. She is present as fragment, warning, grief-object, and a voice that chose precision over gentleness.',
  ...
  },
  {
    ...
    portraitImg: '/assets/literature/character-profiles/ithe-asare.jpg',
    portraitAlt: 'Cinematic profile image for Ithe Asare in a star-map command room.',
    description:
      'Grounded, exact, and loving without making love easy. Ithe’s pulse is famously slow; she notices Sela’s sleepless hands before anyone else and keeps asking for the present tense when grief tries to turn into navigation.',
  ...
  },
  {
    ...
    portraitImg: '/assets/literature/character-profiles/lyren-osei-khan.jpg',
    portraitAlt: 'Cinematic profile image for Lyren Osei-Khan under a damaged survival canopy.',
    description:
      'A disciplined leader whose authority has become sturdier than the institution that granted it. Lyren reads rooms before speaking, names preventable deviations, and keeps formation even when the objective stops being clean.',
  ...
  },
  {
    ...
    portraitImg: '/assets/literature/character-profiles/nae.jpg',
    portraitAlt: 'Cinematic profile image for Nae at a mineral analysis station.',
    description:
      'Rigorous, suspicious, and often right. Nae is the short-haired systems empiricist with a forbidden digest open at breakfast, the one who refuses comforting terms until the evidence survives contact with the planet.',
  ...
  },
  {
    ...
    portraitImg: '/assets/literature/character-profiles/cael-runningwater.jpg',
    portraitAlt: 'Cinematic profile image for Cael Runningwater holding acoustic field notes.',
    description:
      'An artist-listener with a stylus behind one ear and a sketchpad against her thigh, tuned to ventilation pitch, hull tone, and every acoustic mismatch the instruments classify too late.',
  ...
  },
  {
    name: 'Commander Voss',
    slug: 'voss',
    role: 'Commander · physical anchor',
    classification: 'NAIAD — command / watch protocol',
    portraitImg: '/assets/literature/character-profiles/adra-mares.jpg',
    portraitAlt: 'Cinematic profile image for Commander Voss seated in a fractured command chair.',
    description:
      'Practical, blunt, brave, and body-first. Voss turns survival into rules bodies can obey under pressure, refusing to let the archive convert command into theatre.',
  ...
  },
  {
    ...
    portraitImg: '/assets/literature/character-profiles/phoebe-nassar.jpg',
    portraitAlt: 'Cinematic profile image for Phoebe Nassar with an annotated field journal.',
    description:
      'Bright as a flare through a bad filter, funny until naming becomes survival. Phoebe spins ration cubes, pushes morale into language, and makes the world speakable when terror wants everyone silent.',
  ...
  },
  {
    ...
    portraitImg: '/assets/literature/character-profiles/rao.jpg',
    portraitAlt: 'Cinematic profile image for Rao surveying a crystal field on Veyrath.',
    description:
      'Quiet, methodical, and precise about the difference between ground and surface. Rao checks each seal twice, each filter mount three times, then walks first with a surface rod and orange tape because solid is not the same as safe.',
  ...
  },
  {
    ...
    description:
      'Careful, steady, and grieving like someone who organized a life around managing information. Davi knows the fragment well enough to flinch before the clear section arrives and loves Sela enough to fear what listening will cost.',
  ...
  },
  {
    name: 'Dr. Idoss',
    slug: 'dr-idoss',
    role: 'Ship physician · diagnostic witness',
    classification: 'NAIAD medical / post-impact triage',
    portraitImg: '/assets/literature/character-profiles/davi-mares.jpg',
    portraitAlt: 'Cinematic profile image for Dr. Idoss holding a diagnostic tablet.',
    description:
      'A precise medical observer whose work turns injury, pressure, and silence into evidence. Idoss understands that a body can record the planet before a console admits anything is happening.',
    quote: '“A clean scan is not the same as a safe one.”',
    relationship:
      'Tracks the crew’s physical adaptation to Veyrath and the gaps instruments refuse.',
    spoilerLocked: [
      'His charts become one of the few records that can contradict the archive’s smoothing.',
    ],
  },
  {
    name: 'The Knot',
    ...
    portraitImg: '/assets/literature/portraits/the-knot.png',
    portraitAlt: 'Illustrated classified dossier portrait for the Knot.',
    description:
...
export const paleIntervalGlossary: GlossaryTerm[] = [
  ...
  },
  {
    term: 'Clickers',
    definition:
      'Small warning creatures in the Murk whose ordinary movement sounds like a 3-4-3 logic gate. Their silence matters more than their noise: it often precedes Hollow appearances, pressure shifts, or threshold events.',
    category: 'concept',
  },
  {
    term: 'Protocol Seven',
