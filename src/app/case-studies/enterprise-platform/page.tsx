...
export default function EnterprisePlatformPage() {
  return (
    <PageTemplate
      ...
      meta={[{ label: 'Domain', value: 'Enterprise Banking' }, { label: 'Role', value: 'Product Design' }, { label: 'Status', value: 'Write-up in progress' }]}
      content={[{ type: 'text', heading: 'Overview', body: 'A detailed write-up of this enterprise platform engagement is in progress. Related banking work is available across the case-study archive.' }]}
