...
export const metadata: Metadata = {
  ...
  description: 'Improving a large-scale mobile banking app through design system adoption, component creation, and quality support. 1M+ downloads, 4.6★ rating.',
  openGraph: {
    type: 'article',
    url: 'https://larnellepo4855.builtwithrocket.new/case-studies/mobile-banking',
    title: 'Mobile Banking App Design — Larnelle Chambers',
    description: 'Improving a large-scale mobile banking app through design system adoption, component creation, and quality support.',
    images: [
      {
