  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-1 mb-1">
        <div
          ...
          style={{
            ...
            border: '1px solid rgba(125,167,217,0.1)',
          }}
        >
          <span
            style={{
          ...
          <p
            style={{
              ...
              lineHeight: 1.7,
              color: 'rgba(232,208,153,0.8)',
              fontWeight: 300,
              marginBottom: '24px',
            }}
          >
            I supported the ongoing improvement of the NCB mobile app by helping the product design
            team transition key experiences into the new design system, creating missing components,
            and contributing to testing and design quality across the rollout.
          </p>
          <p
            style={{
              fontSize: 'clamp(15px, 2.5vw, 18px)',
          ...
          >
            As the NCB mobile app evolved, different features and journeys had been designed and
            updated over time by multiple teams. That created a familiar enterprise problem: parts
            of the product worked well individually, but the overall experience risked becoming
            visually and structurally inconsistent.
          </p>
          <p
            style={{
              fontSize: 'clamp(15px, 2.5vw, 18px)',
          ...
          >
            My contribution was centered on helping the team move more of the app into the new
            design system in a practical, usable way — guiding designers through the transition,
            creating new reusable components where gaps existed, and helping validate the quality of
        ...
        >
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            {['Design System Adoption', 'Component Design', 'Quality Support', 'iOS + Android'].map(
              (r) => (
                <li
                  key={r}
                  style={{
                    ...
                    color: '#e8d099',
                    padding: '12px 0',
                    borderBottom: '1px solid rgba(125,167,217,0.1)',
                    fontWeight: 300,
                  }}
                >
                  {r}
      ...
      >
        ...
        >
          The app was serving a large, active customer base across iOS and Android, so even small
          inconsistencies had an outsized effect on usability, trust, and delivery speed.
        </p>
          ...
          {[
            ...
            <li
              ...
              style={{
                ...
                fontWeight: 300,
                padding: '12px 0',
                borderBottom: '1px solid rgba(125,167,217,0.08)',
                paddingLeft: '16px',
                position: 'relative',
              }}
            >
              <span style={{ position: 'absolute', left: 0, color: 'rgba(125,167,217,0.4)' }}>
                —
              </span>
              {item}
            </li>
        ...
        {[
          ...
          },
          {
            ...
            items: [
              ...
              'Supporting validation of designs against expected behaviour',
            ],
            dark: false,
          },
        ].map((section) => (
          <div
            key={section.num}
            style={{
              backgroundColor: section.dark ? 'rgba(5,6,15,0.9)' : 'rgba(10,11,28,0.6)',
              padding: '32px',
              border: `1px solid ${section.dark ? 'rgba(125,167,217,0.15)' : 'rgba(125,167,217,0.1)'}`,
            }}
          >
            <span
              style={{
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-1 mb-1">
        ...
        >
          ...
          >
            My work helped strengthen the app in a few key ways. First, it made it easier for
            designers to work within a more unified system. Second, it expanded the design system
            through real product needs. Third, it supported a more consistent and polished customer
          ...
          >
            The broader product continued to perform strongly, with 1M+ downloads, a 4.6★ rating on
            Google Play, and 75+ NPS. While those outcomes were the result of a larger team effort,
            my contribution helped support the consistency, scalability, and design quality behind
            that experience.
          </p>
        </div>
        <div
          ...
          style={{
            ...
            padding: '32px',
            border: '1px solid rgba(125,167,217,0.15)',
            display: 'flex',
            flexDirection: 'column',
            gap: '24px',
          }}
        >
          ...
          {[
            ...
            <div
              key={m.label}
              style={{ borderBottom: '1px solid rgba(125,167,217,0.1)', paddingBottom: '20px' }}
            >
              <span
                style={{
                  fontFamily: "'Cinzel', serif",
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 mb-1">
        {[
          {
            src: '/assets/images/Screenshot_2026-04-04_at_12.01.10_PM-1775322190359.png',
            alt: 'Figma design file showing NCB mobile app screens and component work',
            caption:
              'Updated NCB mobile app — key screens showing improved consistency, hierarchy, and design system alignment',
          },
          {
            src: '/assets/images/image-1775321950897.png',
            alt: 'NCB Mobile Banking app on Google Play Store showing 1M+ downloads and 4.6 star rating',
            caption:
              'App store presence — 1M+ downloads and 4.6★ Google Play rating reflecting improved product quality',
          },
        ].map((tile) => (
          <button
            key={tile.src}
