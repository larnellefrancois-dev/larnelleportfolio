...
export const metadata: Metadata = {
  ...
  description: 'How a fragmented component library evolved into a versioned, living design system with 2000+ components, 65% adoption rate, and 70% faster handoff across web and mobile.',
  openGraph: {
    title: 'Oasis: The NCB Design System — Larnelle Chambers',
    description: 'How a fragmented component library evolved into a versioned, living design system with 2000+ components, 65% adoption rate, and 70% faster handoff across web and mobile.',
  ...
  twitter: {
    ...
    title: 'Oasis: The NCB Design System — Larnelle Chambers',
    description: 'How a fragmented component library evolved into a versioned, living design system with 2000+ components, 65% adoption rate, and 70% faster handoff.',
