...
export const metadata: Metadata = {
  ...
  description:
    'Establishing design operations and systems thinking to improve team efficiency, collaboration, and design consistency across enterprise products.',
  openGraph: {
    type: 'article',
...
export default function DesignOpsPage() {
  return (
    <PageTemplate
      ...
      meta={[
        { label: 'Discipline', value: 'Design Ops' },
      ...
      content={[
        {
          type: 'text',
          heading: 'Overview',
          body: 'A detailed write-up of this design-operations work is in progress. Related systems work is available in the Design Systems section.',
        },
      ]}
      navLinks={[
