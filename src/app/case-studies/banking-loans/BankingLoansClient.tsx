      ...
      <div
        ...
        <div
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', minWidth: 0, flex: 1, overflow: 'hidden' }}>
            ...
            <div>
              <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.08em', color: '#6f87aa', marginBottom: '3px' }}>
        ...
        <div style={{ flex: 1, overflow: 'hidden', position: 'relative' }}>
          {activeTab === 'old' && (
            <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
              <div style={{ padding: '8px clamp(12px, 3vw, 24px)', borderBottom: '1px solid #0e1020', flexShrink: 0, display: 'flex', alignItems: 'center', gap: '8px', backgroundColor: '#080a16' }}>
                <span style={{ width: '6px', height: '6px', borderRadius: '50%', backgroundColor: '#2b3450', display: 'inline-block', flexShrink: 0 }} />
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', color: '#6f87aa', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Earlier Interface</span>
                <span style={{ fontSize: '10px', color: '#44567a' }}>— Create Work Item flow with sidebar navigation</span>
              </div>
          ...
          {activeTab === 'new' && (
            <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
              <div style={{ padding: '8px clamp(12px, 3vw, 24px)', borderBottom: '1px solid #0e1020', flexShrink: 0, display: 'flex', alignItems: 'center', gap: '8px', backgroundColor: '#080a16' }}>
                ...
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', color: '#6f87aa', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Refined Interface</span>
                <span style={{ fontSize: '10px', color: '#44567a' }}>— Streamlined workflow with improved information hierarchy</span>
              </div>
              <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
                <iframe
          ...
          {activeTab === 'compare' && (
            <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ flex: 1, position: 'relative', overflow: 'hidden', display: 'flex' }}>
                ...
                <div style={{ flex: 1, position: 'relative', overflow: 'hidden', borderLeft: '1px solid #1a1d30' }}>
                  <iframe
                    src="/assets/prototypes/banking-loans-new.html"
                    title="New Design Prototype"
                    style={{ position: 'absolute', top: 0, left: 0, width: '1280px', height: '100%', border: 'none', transformOrigin: 'top left' }}
  ...
  return (
    <div
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 mb-1">
        {[
          ...
          <div key={m?.label} style={{ backgroundColor: '#0a0b1c', padding: '24px' }}>
            <span style={{ fontSize: 'clamp(32px, 5vw, 48px)', fontWeight: 200, display: 'block', color: '#f7e6b7' }}>{m?.value}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-1 mt-1">
        <div style={{ backgroundColor: '#f7e6b7', padding: '40px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <span style={{ fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#9fb3cc' }}>The Challenge</span>
          <h2 style={{ fontSize: 'clamp(22px, 3vw, 32px)', fontWeight: 300, lineHeight: 1.2, letterSpacing: '-0.02em', color: '#05060f' }}>Overcoming Dense Workflows</h2>
        ...
        <div style={{ backgroundColor: '#0a0b1c', padding: '40px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <span style={{ fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#6f87aa' }}>Operational Alignment</span>
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '12px', color: '#d9c79a', marginTop: 'auto', borderTop: '1px solid #1a1d30', paddingTop: '24px' }}>
            <span style={{ color: '#6f87aa' }}>{'// SYSTEM_REQUIREMENTS'}</span><br />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-1 mt-1">
        {[
          ...
          <div key={p.phase} style={{ backgroundColor: '#0a0b1c', padding: '32px', display: 'flex', flexDirection: 'column', gap: '16px', minHeight: '260px' }}>
            <span style={{ fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#6f87aa' }}>{p.phase}</span>
            <h3 style={{ fontSize: '20px', fontWeight: 300, lineHeight: 1.2, letterSpacing: '-0.02em', color: '#f7e6b7' }}>{p.title}</h3>
            <p style={{ fontSize: '13px', lineHeight: 1.6, color: '#9fb3cc', fontWeight: 300 }}>{p.copy}</p>
          </div>
        ))}
      </div>

      {/* Key Decisions — full-width dark panel */}
      <div className="mt-1" style={{ backgroundColor: '#f7e6b7', padding: '48px 40px', minHeight: '360px' }}>
        <span style={{ fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#9fb3cc' }}>Key Decisions</span>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mt-10">
          {[
            ...
            <div key={d.title}>
              <h4 style={{ fontSize: '14px', fontWeight: 500, color: '#05060f', marginBottom: '12px' }}>{d.title}</h4>
              <p style={{ fontSize: '13px', lineHeight: 1.6, color: '#8198b8', fontWeight: 300 }}>{d.copy}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-1 mt-1">
        <div className="md:col-span-2" style={{ backgroundColor: '#0a0b1c', padding: '40px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <span style={{ fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#6f87aa' }}>What Changed</span>
          <h3 style={{ fontSize: 'clamp(22px, 3vw, 32px)', fontWeight: 300, lineHeight: 1.2, letterSpacing: '-0.02em', color: '#f7e6b7' }}>The Human Impact</h3>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '10px', fontFamily: "'JetBrains Mono', monospace", fontSize: '11px', color: '#9fb3cc' }}>
            {[
        ...
        <div style={{ backgroundColor: '#0a0b1c', padding: '40px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <span style={{ fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#6f87aa' }}>Outcome / Efficiency</span>
          <div>
            <h3 style={{ fontSize: '18px', fontWeight: 300, color: '#f7e6b7', marginBottom: '8px' }}>Processing Speed</h3>
            <div style={{ fontSize: 'clamp(48px, 6vw, 72px)', fontWeight: 200, letterSpacing: '-0.04em', color: '#f7e6b7', lineHeight: 1, marginTop: '16px' }}>
              40%<span style={{ fontSize: '24px' }}>↑</span>
            </div>
          </div>
        </div>
        <div style={{ backgroundColor: '#0a0b1c', padding: '40px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <span style={{ fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#6f87aa' }}>Outcome / Compliance</span>
          <div>
            <h3 style={{ fontSize: '18px', fontWeight: 300, color: '#f7e6b7', marginBottom: '8px' }}>Error Reduction</h3>
            <div style={{ fontSize: 'clamp(48px, 6vw, 72px)', fontWeight: 200, letterSpacing: '-0.04em', color: '#f7e6b7', lineHeight: 1, marginTop: '16px' }}>
      ...
      <div className="mt-1" style={{ backgroundColor: '#0a0b1c', padding: '48px 40px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#6f87aa' }}>Interactive Prototype</span>
          <h3 style={{ fontSize: 'clamp(22px, 3vw, 32px)', fontWeight: 300, lineHeight: 1.2, letterSpacing: '-0.02em', color: '#f7e6b7' }}>Explore the Design Evolution</h3>
          <p style={{ fontSize: '14px', lineHeight: 1.7, color: '#9fb3cc', fontWeight: 300, maxWidth: '600px' }}>
