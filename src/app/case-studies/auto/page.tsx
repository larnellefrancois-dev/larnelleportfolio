...
export const metadata: Metadata = {
  ...
  description:
    'Improving the structure and usability of auto loan journeys so users could better understand the offering, their options, and how to move forward.',
  openGraph: {
    type: 'article',
    url: 'https://larnellepo4855.builtwithrocket.new/case-studies/auto',
    title: 'Auto Loan Journey Simplification — Larnelle Chambers',
    description:
      'Improving the structure and usability of auto loan journeys for better decision-making.',
    images: [
      {
