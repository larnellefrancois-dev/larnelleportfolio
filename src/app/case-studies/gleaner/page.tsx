...
export const metadata: Metadata = {
  ...
  description: 'Contributing to the design system and editorial experience direction for a content-rich publishing platform with focus on structure, consistency, and reading flow.',
  openGraph: {
    type: 'article',
    url: 'https://larnellepo4855.builtwithrocket.new/case-studies/gleaner',
    title: 'Editorial Design System — The Gleaner | Larnelle Chambers',
    description: 'Contributing to the design system and editorial experience for a content-rich publishing platform.',
    images: [
      {
