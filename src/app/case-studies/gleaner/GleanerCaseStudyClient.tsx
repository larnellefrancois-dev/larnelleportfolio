          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '13px', color: '#b3c4d9', fontWeight: 300 }}>
                Explore the earlier site and the current live experience to see how the Gleaner
                evolved.
              </p>
            </div>
          </div>
          ...
          {activeTab === 'compare' && (
            ...
            >
              ...
              <div style={{ flex: 1, position: 'relative', overflow: 'hidden', display: 'flex' }}>
                <ScaledIframe
                  src={OLD_URL}
                  title="Old Gleaner Design (Wayback Machine)"
                  baseWidth={1280}
                />
                <div
                  style={{
  ...
  return (
    ...
    >
      ...
      <section className="pt-16 pb-12 sm:pt-24 sm:pb-16 lg:pt-[120px] lg:pb-[80px] max-w-[1000px]">
        ...
        >
          Contributed to the design system and editorial experience direction for a content-rich
          publishing platform, with a focus on structure, consistency, and reading flow.
        </p>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 auto-rows-[minmax(300px,auto)] gap-1 mt-1">
        ...
        >
          <div className="mb-10">
            ...
            <p style={{ fontSize: '14px', color: '#9fb3cc', lineHeight: 1.65 }}>
              Editorial platforms carry a different kind of complexity from transactional products.
              The challenge here was not only visual consistency, but also supporting clearer
              content hierarchy, stronger reading experiences, and a more cohesive framework for
              editorial design decisions across the platform.
            </p>
          </div>
          {/* Content Hierarchy Map */}
          <div className="mt-auto border border-[#1a1d30] bg-white p-6 rounded-sm shadow-sm relative">
            <span
              className="absolute -top-2.5 left-4 bg-[#0a0b1c] px-2"
              style={{
                fontFamily: "'JetBrains Mono', monospace",
                fontSize: '9px',
                color: '#6f87aa',
        ...
        {/* Process / Methodology */}
        <div
          className="md:col-span-2 md:row-span-2 flex flex-col relative overflow-hidden"
          style={{
            ...
            {[
              {
                ...
                desc: 'Reviewed content structure, scanability, and presentation patterns.',
              },
              {
                num: '02',
                title: 'Pattern Thinking',
                desc: 'Identified reusable editorial structures and content modules.',
              },
              {
                num: '03',
                title: 'Design Direction',
                desc: 'Helped shape a cleaner, more modern design direction.',
              },
              {
                num: '04',
                title: 'Collaboration',
                desc: 'Worked with local and international stakeholders to align direction.',
              },
            ].map((step, i, arr) => (
              <div
                key={step.num}
                className={`flex items-start gap-6 ${i < arr.length - 1 ? 'pb-8 border-b border-[#0e1020]' : 'pt-8'} ${i > 0 && i < arr.length - 1 ? 'py-8' : ''} group`}
              >
                <span
                  style={{
                    fontFamily: "'JetBrains Mono', monospace",
                  ...
                  className="group-hover:text-[#f7e6b7]"
                >
                  {step.num}
                </span>
                <div>
        ...
        >
          ...
          >
            "Editorial platforms require a different kind of systems thinking — one grounded in
            reading flow, repeatability, and content structure at scale."
          </p>
        </div>
      </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-10">
            {[
              {
                num: '01',
                text: 'Strengthened editorial hierarchy to support scanability and reading flow.',
              },
              {
                num: '02',
                text: 'Focused on reusable structures instead of isolated page-by-page solutions.',
              },
              { num: '03', text: 'Improved readability and scanability across the platform.' },
              {
                num: '04',
                text: 'Treated the work as both a content experience and a system problem.',
              },
            ].map((d) => (
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Typography */}
          <div
            className="border border-[#d9c79a] bg-[#efddb0] p-6 rounded flex flex-col"
            style={{ height: '280px' }}
          >
            <span
              style={{
            ...
            <div className="flex-1 flex flex-col justify-center items-center">
              ...
              <div className="flex items-end gap-4 mt-4 opacity-70">
                ...
                <span
                  style={{ color: '#9fb3cc', fontSize: '16px', lineHeight: 1, marginBottom: '4px' }}
                >
                  Aa
                </span>
              </div>
          ...
          >
            ...
            <div
              className="flex-1 w-full bg-white rounded shadow-lg p-3 flex flex-col gap-3 cursor-pointer"
              style={{
            ...
            >
              <div
                className="w-full bg-[#1a1d30] rounded flex items-center justify-center"
                style={{ height: '80px' }}
              >
                <svg
                  className="w-5 h-5 text-[#6f87aa]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '600px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#8198b8', fontWeight: 300, lineHeight: 1.6 }}>
            Compare the earlier archived site with the current live experience — see how the
            editorial design system shaped the publication's digital presence.
          </p>
        </div>
        <button
          ...
          onTouchStart={(e) => {
            (e.currentTarget as HTMLButtonElement).style.borderColor = '#05060f';
            (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'rgba(255,255,255,0.1)';
          }}
          onTouchEnd={(e) => {
            (e.currentTarget as HTMLButtonElement).style.borderColor = '#d9c79a';
