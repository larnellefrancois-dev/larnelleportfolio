...
export default function CaseStudiesPage() {
  ...
  return (
    ...
    <div className="bg-white text-zinc-900 min-h-screen flex flex-col" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 py-8" style={{ paddingTop: '72px' }}>
      </div>
      ...
      <main className="w-full max-w-[1600px] mx-auto px-6 md:px-12 flex-1 flex flex-col">
        ...
        <section className="mt-16 md:mt-24 mb-20 md:mb-32 max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-zinc-500 leading-relaxed font-light max-w-2xl">
            A selection of deeper project stories across design systems, banking journeys, internal
            tools, editorial platforms, and product structure work.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-32">
          {projects.map((project, index) => {
            ...
            const bgColor = project.dark
              ? isHovered || isActiveTap ? '#000000' : '#121212' : isHovered || isActiveTap ?'#f0f0f0' : '#f9f9f9';
              ...
              >
                <Link
                  ...
                  style={{
                    ...
                    textDecoration: 'none',
                    borderRadius: '2px',
                    outline: isActiveTap ? `2px solid ${project.dark ? '#ffffff' : '#000000'}` : 'none',
                  ...
                  <div className="flex flex-col">
                    <div className="flex justify-between items-start" style={{ marginBottom: '48px' }}>
                      <span
                        style={{
                          fontSize: '10px',
                          fontWeight: 600,
                    ...
                    <div>
                      <h2
                        ...
                        style={{
                          fontSize: project.span === 2 ? 'clamp(1.75rem, 3vw, 2.75rem)' : 'clamp(1.5rem, 2.5vw, 2.25rem)',
