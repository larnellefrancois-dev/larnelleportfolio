      ...
      >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '13px', color: '#b3c4d9', fontWeight: 300 }}>
                Explore the WeLink Caribbean concept platform design — homepage, service discovery,
                and worker listings.
              </p>
            </div>
          </div>
        ...
        >
          ...
          <span style={{ fontSize: '10px', color: '#44567a' }}>
            — Full platform concept with homepage, search, service categories, and app download
          </span>
        </div>
  ...
  return (
    ...
    >
      ...
      <section className="pt-16 pb-12 sm:pt-24 sm:pb-16 lg:pt-[120px] lg:pb-[80px] max-w-[1000px]">
        ...
        >
          A concept platform designed to help users discover skilled workers across the Caribbean
          through clearer browsing, stronger structure, and more practical service discovery.
        </p>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-1 mb-1">
        ...
        >
          ...
          >
            WeLink is a platform designed to help users discover skilled workers and services across
            the Caribbean. The challenge was to create a browsing and discovery experience that felt
            intuitive, trustworthy, and easy to navigate across multiple service categories and
            geographic regions.
          </p>
          <p
            style={{
          ...
          >
            I led the design work across the platform, focusing on service discovery, worker
            profiles, booking flows, and the overall information architecture. The goal was to make
            it easy for users to find what they needed, understand their options, and take action
            with confidence.
          </p>
        </div>
        <div
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1 mt-1">
        ...
        >
          ...
          <p style={{ fontSize: '13px', color: '#9fb3cc', lineHeight: 1.6, maxWidth: '400px' }}>
            Marketplace and services platforms need to reduce ambiguity quickly. Users need to
            understand what the platform offers, how to find the right person, and how to move
            toward action without friction — especially in a multi-region context.
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: 'Reviewed discovery and service-browsing patterns to clarify the core user need and platform logic.',
              },
              {
                num: '02',
                title: 'Information Structuring',
                desc: 'Improved hierarchy, navigation, and service organization so users could better understand how to explore the platform.',
              },
              {
                num: '03',
                title: 'Interface Direction',
                desc: 'Refined interface ideas and page structure to support clearer matching and service discovery.',
              },
              {
                num: '04',
                title: 'Concept Development',
                desc: 'Used the project as a way to shape a stronger product direction, even though the platform did not go live.',
              },
            ].map((step, i) => (
              <div
                key={step.num}
              ...
              >
                ...
                <h4 style={{ fontSize: '16px', fontWeight: 500, color: '#f7e6b7', margin: 0 }}>
                  {step.title}
                </h4>
                <p
                  style={{
      ...
      >
        ...
        >
          "Concept work still benefits from rigor. Even when a platform does not launch, the value
          lies in how clearly the problem is framed and how effectively the solution structure
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-1 mt-1">
        ...
        >
          ...
          >
            {[
              ...
              <div key={d.num} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                ...
                <p style={{ fontSize: '13px', color: '#9fb3cc', lineHeight: 1.6, margin: 0 }}>
                  {d.text}
                </p>
              </div>
            ))}
          ...
          >
            ...
            <div>
              <span style={{ color: '#6f87aa' }}>➜</span> Improved clarity of the platform
              structure.
            </div>
            <div>
              <span style={{ color: '#6f87aa' }}>➜</span> Made service discovery easier to navigate.
            </div>
            <div>
              <span style={{ color: '#6f87aa' }}>➜</span> Strengthened the overall concept journey.
            </div>
            <div>
              <span style={{ color: '#6f87aa' }}>➜</span> Created a clearer foundation for a
              service-matching experience.
            </div>
          </div>
        </div>
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: cat.active ? 'rgba(255,255,255,0.1)' : 'transparent',
                    borderRadius: '999px',
                    padding: '6px 16px',
                    fontFamily: "'JetBrains Mono', monospace",
                    fontSize: '10px',
                    color: cat.active ? '#05060f' : 'rgba(255,255,255,0.6)',
                  }}
                >
                  {cat.label}
                </div>
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: '13px', color: '#f7e6b7', fontWeight: 300 }}>
            Simplifying the Auto Loan Journey
          </span>
        </Link>
        <Link
        ...
        >
          ...
          <span style={{ fontSize: '13px', color: '#f7e6b7', fontWeight: 300 }}>
            Streamlining an Internal Loans Management Platform
          </span>
        </Link>
      </div>
      <SiteFooter />
