...
export const metadata: Metadata = {
  ...
  description: 'Available for design leadership roles, consulting engagements, and speaking opportunities. Contact Larnelle Chambers.',
  openGraph: {
    type: 'website',
    url: 'https://larnellepo4855.builtwithrocket.new/contact',
    title: 'Get in Touch — Larnelle Chambers',
    description: 'Available for design leadership roles, consulting engagements, and speaking opportunities.',
    images: [
      {
