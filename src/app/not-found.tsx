...
export default function NotFound() {
  return (
    <div
      className="ds-container ds-section"
      style={{
        textAlign: 'center',
        minHeight: '60vh',
        display: 'flex',
    ...
    >
      ...
      <h1 style={{ fontSize: 'var(--step-4)', margin: 'var(--space-sm) 0' }}>
        This page slipped the signal.
      </h1>
      ...
      <div className="ds-cta__actions">
        ...
        {SECTIONS.map((s) => (
          <Link key={s.id} href={s.href} className="ds-btn ds-btn--ghost">
            {s.label}
          </Link>
        ))}
      </div>
