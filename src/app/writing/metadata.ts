...
export const metadata: Metadata = {
  ...
  description: 'Thoughts on design systems, engineering culture, and the intersection of architecture and digital products. Exploring scalable foundations for web experiences.',
  openGraph: {
    type: 'website',
    url: 'https://larnellepo4855.builtwithrocket.new/writing',
    title: 'Writing — Larnelle Chambers',
    description: 'Thoughts on design systems, engineering culture, and the intersection of architecture and digital products.',
    images: [
      {
